        ...
        <section id="postAdd" class="pb-0">
            <div class="container-fluid">
                ...
                <input type="text" class="form-control form-control-sm" id="postAd_manage_by" name="postAd_manage_by"
                    value="user" hidden>
                <input type="text" class="form-control form-control-sm" id="postAd_for" name="postAd_for" value="tenant"
                    hidden>
                                ...
                                <div class="col-8">
                                    <div class="form-group">
                                        <label for="postAd_owner_name" class="fw-bold"><i
                                                class="fas fa-user text-secondary me-2"></i>User Names <span><sup
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label for="postAd_description" class="fw-bold"><i
                                                ...
                                                Description</label>
                                            <textarea class="form-control form-control-lg" id="postAd_description" name="postAd_description" rows="5"
