const MadePostAdRentController = function () {
    ...
    $('#postAd_type').change(function () {
        ...
        if (selectedType === 'residential') {
            // Show residential dropdown, hide commercial dropdown
            ...
            // Show commercial dropdown, hide residential dropdown
            $('#postAd_residential_type').parent().hide();
...
const madePostAdRent = new MadePostAdRentController();
madePostAdRent.init();